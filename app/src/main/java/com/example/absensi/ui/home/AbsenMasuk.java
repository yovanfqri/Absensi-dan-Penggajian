...
public class AbsenMasuk extends AppCompatActivity implements LocationListener {
                ...
                mapFragment.getMapAsync(new OnMapReadyCallback() {
                    ...
                    public void onMapReady(@NonNull GoogleMap googleMap) {
                        ...
                        if (i == 1) {
                            ...
                            Toast.makeText(AbsenMasuk.this, "Pilih Lokasi Absen", Toast.LENGTH_SHORT).show();
    ...
    private void absenMasuk(){
        ...
        final String latitude = textLat.getText().toString();
        final String langitude = textLong.getText().toString();

        final ProgressDialog progressDialog = new ProgressDialog(this);
        progressDialog.setMessage("Menyimpan...");
        progressDialog.show();

        StringRequest stringRequest = new StringRequest(Request.Method.POST, DbContract.URL_ABSEN_MASUK,
                new Response.Listener<String>() {
                    @Override
                    public void onResponse(String response) {
                        progressDialog.dismiss();
                        AlertDialog.Builder alertDialogBuilder = new AlertDialog.Builder(AbsenMasuk.this);
                        ...
                        alertDialogBuilder.setNegativeButton("Oke", new DialogInterface.OnClickListener() {
                            ...
                            public void onClick(DialogInterface dialogInterface, int i) {
                                ...
                                Intent z = new Intent(AbsenMasuk.this, MainActivity.class);
                                startActivity(z);
                            }
                        }).create();
                ...
                new Response.ErrorListener() {
                    ...
                    public void onErrorResponse(VolleyError error) {
                        Toast.makeText(AbsenMasuk.this, "Error !" + error.toString() , Toast.LENGTH_SHORT).show();
                    }
                })
        {
            @Nullable
            ...
            protected Map<String, String> getParams() throws AuthFailureError {
                ...
                params.put("jam_msk", jam);
                params.put("jam_plg",jam);
                params.put("lat_msk", latitude);
                params.put("long_msk", langitude);
                return params;
            }
        };
    ...
    private void getLastLocation() {
        try {
            ...
            locationManager.requestLocationUpdates(LocationManager.GPS_PROVIDER,1000 ,0,AbsenMasuk.this);
    ...
    public void tglWaktu(){
        ...
        handler.post(new Runnable() {
            ...
            public void run() {
                ...
                hari.setText(dateFormat.format(date));
                jam.setText(clockFormat.format(date));
